...
CREATE TABLE `user_credit_card` (
  ...
  PRIMARY KEY (`card_id`),
  KEY `user_credit_card_fk_1` (`user_id`),
  CONSTRAINT `user_credit_card_fk_1` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `user_credit_card` VALUES (3,1250045,499,'30-05-2019',1),(3,1250045,499,'30-05-2019',2);
